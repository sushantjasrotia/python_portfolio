...
root=Tk()
root.title("Color finder from image")
root.geometry("800x470+200+200")
...
Label(root, width=120, height=10, bg="#3fdff8").pack()
...
Label(frame,text="Color Finder",font="arial 24 bold",bg="white").place(x=100,y=20)
