...
#desining window
#words = ["an object is an alter", "of on alter alter the cliff", "alternate somabar ti lam che"]
...
b3 = Button(window, text="Another One?", width=12, bg="#fcba03", font="times 20", command=game)
...
x1 = Label(root, text="Lets test your typing speed!", bg="black", fg="white", font="arial")
x1.place(x=100, y=50)

b1 = Button(root, text="G0!", width=12, bg="#fcba03", font="times 20", command=game)
